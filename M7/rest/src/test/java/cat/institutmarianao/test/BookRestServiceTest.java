...
public class BookRestServiceTest {
    ...
    public void existingBookShouldBeReturned() {
        ...
        Book expectedBook = new Book("9788467009477", "La luz y el misterio de las catedrales", "Jose Maria Peridis Perez");
    ...
    public void nonExistentBookShouldReturn404() {
        URI uri = UriBuilder
            .fromUri("http://localhost/books/rest/books")
            .port(8080)
            .build();
    ...
    public void editNonExistentBookShouldReturn404() {
        ...
        URI uri = UriBuilder
            ...
            .build();
        WebTarget target = CLIENT.target(uri);
        Invocation invocation = target.request(MediaType.APPLICATION_JSON).buildPut(Entity.entity(bookToEdit, MediaType.APPLICATION_JSON));
    ...
    public void editExistingBookShouldReturnItEdited() {
        ...
        URI uri = UriBuilder
            ...
            .build();
        WebTarget target = CLIENT.target(uri);
        Invocation invocation = target.request(MediaType.APPLICATION_JSON).buildPut(Entity.entity(book, MediaType.APPLICATION_JSON));
        ...
        invocation = target.request(MediaType.APPLICATION_JSON).buildPut(Entity.entity(book, MediaType.APPLICATION_JSON));
    ...
    public void deleteExistingBookShouldReturn200() {
        ...
        invocation = target.request(MediaType.APPLICATION_JSON).buildPost(Entity.entity(book, MediaType.APPLICATION_JSON));
        invocation.invoke();
    }
    ...
    public void shouldReturnListOfBooksContainingTitle() {
        ...
        URI uri = UriBuilder
            .fromUri("http://localhost/books/rest/books/findByTitle")
            .port(8080)
            .build();
