...
public class JPAUserDAO implements UserDAO {
    ...
    public User getById(Integer id) {
        try {
            return (User) entityManager
                .createQuery("select object(o) from User o " + "where o.id = :id")
                .setParameter("id", id)
                .getSingleResult();
    ...
    public User findUserByUsername(String username) {
        try {
            return (User) entityManager
                .createQuery("select object(o) from User o " + "where o.username = :username")
    ...
    public List<User> findActiveUsers() {
        try {
            return entityManager
                .createQuery("select object(o) from User o " + "where o.active= true")
                .getResultList();
        } catch (NoResultException e) {
            return null;
        }
    ...
    public User findUserWithHighestRank() {
        try {
            return (User) entityManager
                .createQuery("select object(o) from User o order by o.rank DESC")
                .setMaxResults(1)
                .getSingleResult();
        } catch (NoResultException e) {
            return null;
